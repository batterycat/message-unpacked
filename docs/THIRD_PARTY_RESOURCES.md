...
| Cloudflare Workers + Durable Objects | Hosted runtime service       | Cloudflare      | https://developers.cloudflare.com/durable-objects/ | Optional Phase 2 ephemeral classroom rooms; no student history is intentionally stored | Hosted-service terms and account limits apply; no Cloudflare software is redistributed | Configure an allowed origin, review retention and abuse controls, and keep the static site usable without the service  | 2026-07-19, conditionally approved |

## Optional Phase 2 Tooling

| Resource     | Category        | Owner/publisher | Canonical source                          | Project use                                                                                                           | License/permission | Attribution/notices                                                                           | Reviewed                           |
| ------------ | --------------- | --------------- | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ------------------ | --------------------------------------------------------------------------------------------- | ---------------------------------- |
| Wrangler CLI | Deployment tool | Cloudflare      | https://github.com/cloudflare/workers-sdk | Local development and deployment of `workers/room-worker.ts`; invoked with `pnpm dlx`, not bundled in the static site | Apache-2.0         | Preserve license if redistributed; review the exact fetched version before release automation | 2026-07-19, conditionally approved |
