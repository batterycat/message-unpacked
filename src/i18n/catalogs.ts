...
const zhTW = {
  ...
  caseSelection: {
    ...
    recommendedBadge: '建議',
    sensitiveContent: '敏感內容：{content}',
    trustedAdultRecommended: '建議由可信任的大人陪同',
    empty: '至少選擇一題才能繼續。',
...
const en: MessageCatalog = {
  ...
  caseSelection: {
    ...
    sensitiveContent: 'Sensitive content: {content}',
    trustedAdultRecommended: 'Trusted adult guidance recommended',
